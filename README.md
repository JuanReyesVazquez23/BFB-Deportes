...
| Panel de administración (borrar/restaurar equipos incorrectos, borrar/reactivar ligas completas) | ✅ Completo — 5 taps en el footer, solo funcional para usuarios en `ADMIN_USERNAMES` |
